...
> Full RL pipeline applied to BTC-USD: custom trading environment, tabular Q-learning baseline, Deep Q-Network with experience replay and target network, ablation study, policy analysis, and reward shaping.
